...
const LinkProgressContext = createContext<LinkProgressContextValue | null>(null);
...
export const LinkProgressProvider = ({ children }: { children: ReactNode }) => {
  ...
  return <LinkProgressContext.Provider value={value}>{children}</LinkProgressContext.Provider>;
};

export const useLinkProgress = () => {
